...
import io.arkitik.travako.starter.spring.exposed.custom.units.TravakoExposedDataSourceProperties
 ...
 */
@Configuration
@EnableConfigurationProperties(TravakoExposedDataSourceProperties::class)
class CustomTravakoSpringExposedStarter {
    ...
    fun travakoExposedAppDatabase(
        travakoExposedDataSourceProperties: TravakoExposedDataSourceProperties,
