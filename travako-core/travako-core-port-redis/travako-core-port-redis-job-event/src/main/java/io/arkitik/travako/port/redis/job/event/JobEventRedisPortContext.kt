package io.arkitik.travako.port.redis.job.event

import io.arkitik.travako.adapter.redis.job.event.JobEventStoreImpl
import io.arkitik.travako.adapter.redis.job.event.RunnerJobEventStateStoreImpl
 ...
 */
@Configuration
class JobEventRedisPortContext {
